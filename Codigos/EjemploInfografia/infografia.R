...
library(extrafont)
library(useful)
#font_import() # Import all fonts (Windows)
...
p2 <- p2 + kobe_theme2() + scale_linetype_discrete("GROUP")
...
# # Salida final
library(grid)
pdf("C:/Users/jota9/Documents/datavisualizationR/Codigos/EjemploInfografia/Infographics1.pdf", width = 10, height = 20)
grid.newpage() 
