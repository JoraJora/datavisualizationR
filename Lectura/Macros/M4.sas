...
* Problem, convert agewed variable into
	...
	to published stats);
libname y "C:\Users\jota9\Google Drive\Trabajos_Afuera\SantoTomas\Lectura\Macros";
...
data age; /* Using both pieces */
	set y.gssage;
	%bins(agewed, 20, &maxagewed);
	%bins(agekdbrn, 20, &maxagekdbrn);
	run;

proc sql;
select agewed, agekdbrn, agewed10, agekdbrn10 from age;
quit;
